...
class MountainCarTrain:
    ...
    def orginalTry(self,currentState,eps, ep_rewards, aggr_ep_rewards):
        rewardSum = 0
        max_position=-99
        ...
        # Stats
        ep_rewards.append(rewardSum)
        average_reward = sum(ep_rewards)/(eps+1)
        aggr_ep_rewards['ep'].append(eps)
    ...
    def start(self):
        ...
        for eps in range(self.episodeNum):
            ...
            self.orginalTry(currentState, eps, ep_rewards, aggr_ep_rewards)
